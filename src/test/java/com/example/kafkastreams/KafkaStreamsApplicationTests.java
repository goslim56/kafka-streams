...
//    KafkaStreamsConfiguration kafkaConfig;
    ...
    @Autowired
    CustomInfrastructureCustomizer customInfrastructureCustomizer;
    ...
    public void setup() {
        ...
        builder.stream("streams-app-processor-input").to("streams-app-processor-repartition");
